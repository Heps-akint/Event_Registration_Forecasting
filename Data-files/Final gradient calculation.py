def calculate_weighted_average(gradients_with_errors):
    ...
    return average_gradient1, error_average_gradient1
...
def calculate_average_and_error(gradients_with_errors):
    ...
    return average_gradient2, error_average_gradient2
...
average_gradient1, error_average_gradient1 = calculate_weighted_average(gradients_with_errors)
print(f"Average Weighted Gradient: {average_gradient1}, Error of the Average: {error_average_gradient1}")

average_gradient2, error_average_gradient2 = calculate_average_and_error(gradients_with_errors)
